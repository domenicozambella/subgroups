...
\begin{fact}
  ...
  \begin{itemize}
    ...
    \item [2.] for every $\EuScript C_1,\dots,\EuScript C_n$ covering $\EuScript D$ there is some $i$ such that ${\rm orb}(\EuScript C_i/A)$ has fip.
  \end{itemize}
\end{fact}
...
\begin{fact}\label{fact_Lig}
  ...
  \begin{itemize}
    ...
    \item [2.] for every $\EuScript C_1,\dots,\EuScript C_n$ covering $\EuScript D$ there is some $i$ such that ${\rm orbf}(\EuScript C_i/A)$ has fip.
  \end{itemize}
\end{fact}
...
\begin{theorem}
  ...
  Then the relation below is stable
